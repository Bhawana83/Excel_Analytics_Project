...
export default function HomePage() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b  font-sans text-slate-800">

      {/* Navbar */}
      <header className="md:fixed w-full top-0 z-50 bg-stone-100 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="text-3xl font-bold bg-gradient-to-r from-cyan-600 to-sky-800 bg-clip-text text-transparent select-none">
              Excel Analyzer
            </div>
          ...
          <div className="hidden md:flex ml-3 gap-4">
            <Link to="/login">
              <button className="px-5 py-2 rounded-lg border border-sky-500 text-sky-700 transition-all hover:scale-105 hover:bg-sky-700 hover:text-white font-medium cursor-pointer">
                Login
              </button>
            </Link>
            <Link to="/register">
              <button className="px-5 py-2 rounded-lg bg-gradient-to-r from-cyan-600 to-sky-700 text-white font-medium flex items-center gap-1 cursor-pointer transition-all hover:scale-105">
      ...
      <section className="relative overflow-hidden pt-20 md:pt-28">
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2">
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight">
              ...
              <span className="bg-gradient-to-r from-cyan-600 to-sky-700 bg-clip-text text-transparent"> actionable insights</span>
            </h1>
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <Link to="/register">
                <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-sky-700 text-white rounded-lg font-semibold shadow hover:scale-105 transition-all flex items-center gap-2">
                  Get Started
                  <ArrowRight size={16} />
                </button>
              </Link>
              <Link to="/login">
                <button className="px-6 py-3 border border-sky-600 text-sky-700 rounded-lg font-semibold transition-all duration-200 hover:bg-sky-700 hover:text-white cursor-pointer hover:scale-105">
                  Login
                </button>
              </Link>
            </div>
          ...
          <div className="w-full lg:w-1/2 bg-white/70 backdrop-blur-md rounded-3xl shadow-lg p-6 transition-all hover:scale-105">
            <h3 className="text-xl font-bold text-sky-700 mb-4">Why Choose Excel Analyzer?</h3>
        ...
        <div className="absolute top-0 right-0 w-72 h-72 bg-sky-500 rounded-full mix-blend-multiply filter blur-3xl opacity-40 -z-10"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-sky-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 -z-10"></div>
      </section>

      {/* Features Section */}
      <section id="features" className="max-w-7xl mx-auto px-6 py-28">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-500 to-sky-700 bg-clip-text text-transparent">
            Core Capabilities
          </h2>
      ...
      {/* Footer */}
      <footer className="mt-20 bg-gradient-to-r from-cyan-300 to-sky-300 border-t">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="text-xl font-bold bg-gradient-to-r from-cyan-600 to-sky-700 bg-clip-text text-transparent">
              ExcelAnalyzer
            </div>
        ...
        <div className="border-t pt-6 text-center text-xs text-white">
